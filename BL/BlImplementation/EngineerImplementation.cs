...
internal class EngineerImplementation : IEngineer 
{
    ...
    public int AddEngineer(BO.Engineer engineer) // add engineer to the system
    {
        ...
        try
        { 
            int engineerId = dal_.Engineer.Create(BoDoAdapter(engineer)); // create new DO.Engineer
            return engineerId;
        }
    ...
    public void UpdateEngineer(BO.Engineer engineer)
    {
        ...
        if(engineer.Task.Id <= 0)
            throw new BadTaskInEngineerException("Task id must be above 0");
    ...
    private static DO.Engineer BoDoAdapter(this BO.Engineer engineer) // adapter from BO.Engineer to DO.Engineer
    {
    ...
    private static BO.Engineer DoBoAdapter( this DO.Engineer engineer, BO.TaskInEngineer taskInEngineer) // adapter from DO.Engineer to BO.Engineer
    {
